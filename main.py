            ...
            while True:
                ...
                if choice == "1":
                    print("La battaglia si risolve rapidamente, ma sanguinosamente ed essendoti fatto "
                          ...
                          "termina la tua carriera militare, e ti dedichi dopo questo evento alla carriera "
                          "ecclesiastica."
                          "\n")
        ...
        def try_become_bishop(self):
            if self.player.consensus >= 20:
                print("Il giorno è grigio, come se il cielo stesso volesse trattenere il fiato."
                      ...
                      "Gli occhi puntati su di te sono molti: alcuni pieni di speranza, altri di sospetto, "
                      "alcuni cercano solo segni di debolezza"
                      "Quando l’anello episcopale viene infilato al tuo dito, non senti solo l’onore. Senti il peso"
                      "Quando ti consegnano il bastone pastorale, non senti solo il potere. Senti la responsabilità."
